...
import com.zhuxiaoqing.zxqrecyclerviewlibrary.listeners.AppBarStateChangeListener;
...
public class ZXQRecyclerView extends RecyclerView {
    private boolean isLoadingData = false;
    private boolean isNoMore = false;
    private int mLoadingMoreProgressStyle = ProgressStyle.BallRotate;//加载动画类型
    ...
    public ZXQRecyclerView(Context context) {
        this(context, null);
    }

    public ZXQRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZXQRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setFootViewOnClick(OnClickListener click){
        mFootView.setOnClickListener(click);
    }
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    Log.e(getClass().getName(),"show");
                    ZXQRecyclerView.this.setVisibility(View.GONE);
                } else {
                    Log.e(getClass().getName(),"GONE");

                    mEmptyView.setVisibility(View.GONE);
                    ZXQRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
    ...
    public void setTopTextColor(int color){
        mRefreshHeader.setmStatusTextView_color(color);
    }
    ...
    public void setShowTime(boolean showTime){
        mRefreshHeader.setShowTime(showTime);
    }
    ...
    public void setLoadMoerColor(int color){
        if(mFootView instanceof LoadingMoreFooter){
            ((LoadingMoreFooter) mFootView).setLoadMoerColor(color);
        }
    }
    ...
    public void setNoMoreTextViewColor(int color){
        if(mFootView instanceof LoadingMoreFooter){
            ((LoadingMoreFooter) mFootView).setNoMoreTextViewColor(color);
        }
    }
